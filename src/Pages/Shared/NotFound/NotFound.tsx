...
<h4 className='errorh4'>There's nothing here!</h4>
<p className='errorP'>Sorry, the page you were looking for in this blog does not exist.</p>
<Link style={{textDecoration:'none'}} className="homepage errorA" to='/' >Home</Link>
</div>
        </div>
    );
};
